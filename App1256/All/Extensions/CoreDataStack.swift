...
class CoreDataStack {
    ...
    func deleteOper(withOpName name: String, completion: @escaping () -> Void) {

        let context = CoreDataStack.shared.persistentContainer.viewContext
        let fetchRequest: NSFetchRequest<OperModel> = OperModel.fetchRequest()

        fetchRequest.predicate = NSPredicate(format: "opName == %@", name)
